...
def write_obj_with_texture(obj_name, vertices, triangles, texture, uv_coords,image_name):
    ...
    mtl1=image_name.replace('.png', '.mtl')
    texture1=image_name.replace('.png', '_texture.png')
    ...
    with open(mtl_name, 'w') as f:
        ...
        s = 'map_Kd {}\n'.format(texture1) # map to image
        
    

    # write texture as png
    imsave(texture_name, texture)
    subprocess.call('C:\Windows\System32\powershell.exe f3d obj_name --output=11.png', shell=True)
    os.popen("f3d obj_name --output=11.png")
